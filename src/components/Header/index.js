                    ...
                    <div>
                        {
                            (path.pathname === '/')
                                ...
                                : <div className='flex items-center'>
                                    <button aria-label="Toggle Dark Mode" type="button" class="circle-button mx-3">
                                    ...
                                    <button className="flex align-middle rounded-md bg-transparent w-6 h-6 border-0 cursor-pointer outline-none ml-3" title='MENU' onClick={query.toggle}>
